...
if __name__ == "__main__":
    ...
    print("Total###########################")
    print("Sents: {0}".format(num_sents["train"] + num_sents["dev"] +num_sents["test"]))
    ...
    print()
    print("Holders: {0}".format(num_source["train"] + num_source["dev"] + num_source["test"]))
    ...
    print("---- discontinuous: {0}".format(np.sum(list(discontinuous_holder.values()))))
    print()
    print("Targets: {0}".format(num_targets["train"] + num_targets["dev"] + num_targets["test"]))
    ...
    print()
    print("Polar Exps.: {0}".format(num_polar_exp["train"] + num_polar_exp["dev"] + num_polar_exp["test"]))
